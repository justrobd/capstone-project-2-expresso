...
timesheetsRouter.get('/', (req, res, next) => {
	const sql = 'SELECT * FROM Timesheet WHERE Timesheet.employee_id = $timesheetId';
...
timesheetsRouter.put('/:timesheetId', (req, res, next) => {
	...
	const employeeSql = 'SELECT * FROM Employee WHERE Employee.id = $employeeId;';
	const employeeValue = {$employeeId: employeeId};

	db.get(employeeSql, employeeValue, (error, employee) => {
		if(error) {
			next(error);
		} else {
			if(!hours || !rate || !date || !employee) {
